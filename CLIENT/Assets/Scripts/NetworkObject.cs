...
public class NetworkObject : MonoBehaviour
{
    ...
    {
        if (!currentObjects.ContainsKey(obj.networkID)) currentObjects.Add(obj.networkID, obj); 
    }
    ...
    {
        if (!currentObjects.ContainsKey(networkID)) currentObjects.Remove(networkID);
    }
